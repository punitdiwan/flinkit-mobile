      ...
      {ordersdata?.length == 0 ? (
        ...
        <ScrollView>
          ...
          {upcomingOrder ? (
              ...
              {ordersdata &&ordersdata.map(item => (
                ...
                >
                  ...
                  >
                    ...
                    <View>
                      <Text style={{ fontWeight: "500" }}>
                        Date : <Text style={{color:"black"}}>{item?.dateoforder}</Text>
                      </Text>
                    </View>
                  </View>
                  ...
                  >
                    ...
                    <View>
                      <Text style={{ fontWeight: "500",color:"rgb(105,175,94)"}}>+<Text style={{color:"rgb(105,174,94)"}}>{item?.orderitems.length - 1}</Text></Text>
                    </View>
                  </View>
                  {/* <Text
            ...
            <View>
              <Text
                style={{ fontWeight: "500", fontSize: 20, marginVertical: 10 }}
              >
